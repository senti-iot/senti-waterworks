...
const FullScreen = createControlComponent((props) => {
	//Hooks
	//Redux
	...
	//Handlers
	let container = L.DomUtil.create('div', 'leaflet-control-fullscreen leaflet-bar');
	const Fullscreen = new Control.extend({
		options: {
...
withLeaflet(withStyles(styles, { withTheme: true })(
	class Fullscreen extends MapControl {
